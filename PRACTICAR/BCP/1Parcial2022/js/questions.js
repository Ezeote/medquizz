let questions = [
    ...
    {
    "numb": 8,
    "question": "Una paciente presenta una infección urinaria baja causada por una cepa de Escherichia coli productora de Betalactamasa de espectro ampliado (BLEA). ¿Cual de los siguientes antibióticos podría utilizarse en el tratamiento de esta paciente considerando que esta betalactamasa no lo afecta?",
    ...
    {
    "numb": 10,
    "question": "En el proceso de identificación de una cepa bacteriana se obtienen los siguientes resultados: coco gram positivo, no exigente, catalasa positivo y DNAsa positivo. ¿A cuál de los siguientes microorganismos puede corresponder?",
    ...
    {
    "numb": 14,
    "question": "En un paciente con meningoencefalitis aguda supurada, se realiza punción lumbar y a partir del líquido cefaloraquídeo se cultiva Neisseria meningitidis. <br> ¿Para cuál de los siguientes antibióticos es necesario realizar un estudio de susceptibilidad que oriente la quimioprofilaxis de los contactos de este paciente?",
    ...
    {
    "numb": 15,
    "question": "En el laboratorio se aisló una cepa deHaemophilus influenzae a partir del hemocultivo de un adulto con diagnóstico clínico de neumonía. Se realizó una prueba rápida colorimétrica con un disco impregnado de nitrocefina que resultó positiva. ¿Qué indica este resultado?",
    ...
    "answer": ["c. Escherichia coli enteropatogénico (EPEC)"],
    "options": [
    "a. Escherichia coli enterotoxigénica (ETEC)",
    "b. Shigella sonnei",
    "c. Escherichia coli enteropatogénico (EPEC)",
    ...
    {
    "numb": 19,
    "question": "En el diagnóstico microbiológico de las meningoencefalitis agudas supuradas, se realiza una punción lumbar para obtener líquido cefaloraquídeo. La muestra se cultiva en agar sangre y agar chocolate y luego de la incubación se observa desarrollo en ambos medios. ¿Cuál es el procedimiento a seguir?",
    ...
    {
    "numb": 23,
    "question": "¿Cuál de las siguientes opciones indica dos especies bacterianas naturalmente resistentes a penicilina?",
    ...
    {
    "numb": 24,
    "question": "¿Por qué es importante la ventilación en la prevención de la infección por SARS-COV-2?",
    ...
    {
    "numb": 29,
    "question": "¿Cuál de los siguientes factores de virulencia posibilitan la evasión del sistema inmune por parte de de S. pneumoniae cuando causa infección?",
    ...
    {
    "numb": 30,
    "question": "¿Qué función cumple la proteína F del virus respiratorio sincicial (VRS)?",
    ...
    {
    "numb": 31,
    "question": "¿Cual de los siguientes antibióticos actúa inhibiendo la síntesis proteica?",
    "answer": ["c. Macrólidos"],
    "options": [
    "a. Glicopéptidos",
    "b. Fluoroquinolonas",
    ...
    {
    "numb": 33,
    "question": "En un paciente de 2 meses de edad que presenta sindrome de piel escaldada ¿Cuál de los siguientes factores de virulencia debe producir el microorganismo causal?",
    ...
    "b. inhibe el crecimiento de bacterias exigentes nutricionalmente y diferencia bacterias gram negativas de las gran positivas",
    ...
    {
    "numb": 36,
    "question": "¿Que pasos deberán ocurrir durante la infección por un virus como Enterovirus, cuando ingresa al organismo por la vía oral y produce manifestaciones en el sistema nervioso central?",
    ...
    {
    "numb": 37,
    "question": "Lactante de 2 meses, sano, con diagnóstico de probable infección urinaria por presentar fiebre y detectar nitritos y leucocitos en el examen de orina. Señale cuál de los siguientes microorganismos puede ser con mayor probabilidad el agente etiológico de esta infección:",
    ...
    {
    "numb": 38,
    "question": "De una muestra de esputo se aisló un bacilo Gram negativo que creció en agar chocolate y se identificó como Haemophilus spp. ¿Qué pruebas utilizaría para determinar la especie?",
    ...
    {
    "numb": 42,
    "question": "¿Cómo se confirma el diagnóstico etiológico de una queratitis por Acanthamoeba spp?",
    ...
    "options": [
    "a. Productos de excreción-secreción de Ascaris lumbricoides.",
    ...
    {
    "numb": 47,
    "question": "¿Cuál de estas acciones patógenas es producida por el parasitismo por Trichiuris trichiura?",
    "answer": ["c. Depleción de sangre a través de la mucosa intestinal"],
    "options": [
    "a. Granulomas producidos por su migración larvaria",
    "b. Destrucción de jugos biliares por proteasas",
    "c. Depleción de sangre a través de la mucosa intestinal",
    "d. Acción mecánica por las hembras en su salida activa por el ano"
    ],
    "discipline": "Parasito",
    "comment": "",
    },
    ...
    {
    "numb": 49,
    "question": "¿Cuál de los siguientes mecanismos de transmisión en la Enfermedad de Chagas era el causante de la mayor cantidad de casos en el área no endémica?",
    "answer": ["d. transfusional"],
    "options": [
    "a. oral",
    "b. vectorial",
    "c. vertical",
    ...
    {
    "numb": 50,
    "question": "Los métodos diagnósticos basados en enzimo inmuno ensayo (ELISA) permiten detectar:",
    "answer": ["a. la seroconversión del paciente"],
    "options": [
    "a. la seroconversión del paciente",
    "b. la separación de antígenos a partir del suero del paciente",
    "c. la precipitación de complejos preformados en el suero del paciente"
    ],
    "discipline": "Parasito",
    "comment": "",
    },
    ...
    {
    "numb": 51,
    "question": "¿Cuál es la presentación clínica habitual en un paciente con sospecha de neurotoxoplasmosis?",
    "answer": ["d. Cefalea y déficit focal neurológico"],
    "options": [
    "a. Adenomegalias carotídeas y cervicales.",
    "b. Sindrome febril prolongado.",
    "c. Hepato - Esplenomegalia.",
    "d. Cefalea y déficit focal neurológico"
    ],
    "discipline": "Parasito",
    "comment": "",
    },
    ...
    {
    "numb": 52,
    "question": "La respuesta inmune adaptativa celular especifica dirigida frente a infecciones por parásitos helmintos se caracteriza por una respuesta polarizada:",
    "answer": ["d. hacia Th2 con secreción principalmente de IL-4, IL-5, IL-13."],
    "options": [
    "a. hacia Th1 con secreción principalmente de IL-4, IL-5, IL-13.",
    "b. hacia Th2 con secreción principalmente de IL-17, IL-6.",
    "c. hacia Th17 con secreción principalmente de IL-2 e IFNg.",
    "d. hacia Th2 con secreción principalmente de IL-4, IL-5, IL-13."
    ],
    "discipline": "Parasito",
    "comment": "",
    },
    ...
    {
    "numb": 53,
    "question": "¿La presencia de qué estructuras caracteriza al neurocisticerco?",
    "answer": ["c. Escolex invaginado."],
    "options": [
    "a. Proglótides en su interior.",
    "b. Embrión hexacanto.",
    "c. Escolex invaginado.",
    "d. Huevos larvados en su interior."
    ],
    "discipline": "Parasito",
    "comment": "",
    },
    ...
    {
    "numb": 54,
    "question": "¿Cómo se infecta el perro con Echinococcus granulosus?",
    "answer": ["b. ingestión de quiste hidático"],
    "options": [
    "a. ingestión de huevos",
    "b. ingestión de quiste hidático",
    "c. ingestión de proglótides",
    "d. ingestión de cisticercos "
    ],
    "discipline": "Parasito",
    "comment": "",
    },
    ...
    {
    "numb": 55,
    "question": "En relación a la respuesta inmune humoral, ¿cuál de las opciones indica lo correcto para cada tipo de anticuerpos?",
    ...
    {
    "numb": 56,
    "question": "¿Cuáles son los agentes más frecuentes de queratitis fúngicas?",
    ...
    {
    "numb": 57,
    "question": "¿Cuál de los siguientes métodos es el adecuado para el diagnóstico de la Tricocefalosis?",
    ...
    {
    "numb": 59,
    "question": "¿Cuáles de las siguientes técnicas se pueden usar para diagnosticar Enfermedad de Chagas en la etapa latente?",
    ...
    {
    "numb": 60,
    "question": "¿Qué tipo de zoonosis es la Balantidiosis?",
