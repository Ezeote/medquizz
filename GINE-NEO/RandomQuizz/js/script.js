import { questionsJulio2021, questionsAgosto2021 } from './questions.js';

// Seleccionar las preguntas que quieres usar
let questions = [...questionsJulio2021, ...questionsAgosto2021];
...
// Función para seleccionar disciplinas
function selectDisciplines() {
    ...
    filteredQuestions = shuffleArray(filteredQuestions).slice(0, 10); // Seleccionar 10 preguntas aleatorias
    filteredQuestions.forEach((question, index) => question.numb = index + 1); // Renumerar preguntas del 1 al 10
}
