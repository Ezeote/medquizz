...
let questions = [
  {
    "numb": 1,
    "question": "El resultado de un antibiograma de Staphylococcus aureus es el siguiente:\nResistencia a: penicilina, eritromicina y clindamicina (test D positivo). Sensible a:\ncefoxitina, gentamicina y trimetoprim-sulfametoxazol.\nSe trata de una cepa:",
  ...
  {
    "numb": 3,
    "question": "¿Qué características espera encontrar en el líquido cefalorraquídeo de un\npaciente con una meningoencefalitis aguda por Neisseria meningitidis?\n",
  ...
  {
    "numb": 5,
    "question": "Paciente de sexo masculino, 32 años, que consulta por corrimiento purulento\nuretral. Con planteo de uretritis gonocóccica el médico indica ceftriaxona y\nazitromicina. ¿Por qué indicó un tratamiento antibiótico combinado?",
  ...
  {
    "numb": 6,
    "question": "Streptococcus pyogenes es el agente etiológico de la escarlatina. ¿Cuál de los\nsiguientes factores de virulencia es el responsable del rash característico de\nesta enfermedad?",
  ...
  {
    "numb": 7,
    "question": "¿Cuáles son los principales blancos de acción de las distintas opciones de la\nterapia triple antirretroviral que se pueden encontrar?",
  ...
  {
    "numb": 8,
    "question": "¿Qué marcadores porta un individuo con una infección resuelta por el virus de\nla hepatitis B (HBV)?",
  ...
  {
    "numb": 9,
    "question": "Escherichia coli enterotoxigénica (ETEC) es agente de diarrea aguda en niños\nde regiones pobres, y también de enfermedad esporádica o epidémica de\norigen alimentario. Esta bacteria, durante la infección, induce hipersecreción de\nagua y electrolitos a través de:",
  ...
  {
    "numb": 10,
    "question": "Usted está asistiendo a una mujer de 24 años que consulta por disuria, fiebre y\ndolor lumbar. El resultado del urocultivo informa: desarrolla más de 100000\nUFC/ml de Escherichia coli. Sensible a: cefuroxime, amoxicilina clavulánico,\ntrimetoprim sulfametoxazol, nitrofurantoína, fosfomicina-trometamol.\nResistente a: ciprofloxacina, ampicilina, cefradina. ¿Qué antibiótico elegiría\npara el tratamiento?",
    "answer": "Cefuroxime",
    "options": [
      "Cefradina",
      "Cefuroxime",
  ...
  {
    "numb": 11,
    "question": "Teniendo en cuenta el perfil de resistencia a betalactámicos de la cepa aislada\ndel urocultivo en la pregunta anterior, ¿cuál es el mecanismo de resistencia a\nbetalactámicos que presenta?",
  ...
  {
    "numb": 12,
    "question": "¿Qué espera encontrar en el examen microscópico directo de una muestra de\nexpectoración representativa del tracto respiratorio inferior obtenida de un\npaciente con neumonia por Streptococcus pneumoniae?",
  ...
  {
    "numb": 13,
    "question": "El cultivo obtenido de un exudado de una lesión impetiginizada informa\ncrecimiento de colonias beta hemolíticas. En el laboratorio realizan tinción de\nGram observándose cocos gram positivos y realizan prueba de la catalasa\nvisualizándose la formación de burbujas.\n¿A cuál de las siguientes especies bacterianas es más probable que\npertenezca este aislamiento?",
  ...
  {
    "numb": 14,
    "question": "¿Qué clase de beta lactamasas pueden inhibirse con el uso de inhibidores\nderivados de beta lactámicos como ser el ácido clavulánico, el tazobactam y el\nsulbactam?",
  ...
  {
    "numb": 15,
    "question": "¿Qué clase de Carbapenemasa presenta un test de sinergia positivo entre el\nEDTA y el meropenem?",
  ...
  {
    "numb": 16,
    "question": "¿Cuál de los siguientes métodos diagnósticos se utiliza en el screening de\nenfermedad de Chagas en las embarazadas?",
    "answer": "ELISA IgG",
    "options": [
      "ELISA IgG",
      "Método de Strout",
  ...
  {
    "numb": 18,
    "question": "¿Cómo se puede presentar clínicamente la infección por Fasciola hepatica en\nhumanos?",
  ...
  {
    "numb": 19,
    "question": "¿Cuál de las siguientes enfermedades es transmitida por el mosquito Aedes\naegypti?",
  ...
  {
    "numb": 20,
    "question": "¿A qué corresponden los surcos acarinos en la infección por Sarcoptes\nscabiei?",
  ...
  {
    "numb": 21,
    "question": "¿Cuál es la principal forma de adquisición de las infecciones producidas por\nlevaduras del género Candida?",
  ...
  {
    "numb": 22,
    "question": "¿De cuál de los siguientes cuadros clínicos son agentes frecuentes las\nlevaduras del género Malassezia?",
    "answer": "Foliculitis",
    "options": [
      "Foliculitis",
      "Vulvovaginitis",
  ...
  {
    "numb": 23,
    "question": "¿Cuál de las siguientes opciones indica una forma de transmisión de la\ntoxoplasmosis por vía oral?",
  ...
  {
    "numb": 24,
    "question": "¿Cuál es la principal vía de transmisión de la enfermedad de Chagas en el\nUruguay en la actualidad?",
    "answer": "Vertical",
    "options": [
      "Oral",
      "Vertical",
  ...
  {
    "numb": 25,
    "question": "¿Cuál es la manifestación clínica más frecuente en la reactivación de una\ntoxoplasmosis crónica en pacientes inmunocomprometidos?\n",
  ...
  {
    "numb": 26,
    "question": "¿Cuál de los siguientes agentes es responsable de la miasis que se produce en\nlesiones descuidadas, malolientes o infectadas?",
  ...
  {
    "numb": 28,
    "question": "¿Cuál es uno de los mecanismos de acción patógena de los trofozoítos de\nGiardia lamblia?",
  ...
  {
    "numb": 29,
    "question": "¿Qué ocurre con el fotón incidente cuando existe interacción de la radiación\ncon la materia a través del efecto fotoeléctrico?",
  ...
  {
    "numb": 30,
    "question": "¿Cuál de las siguientes alteraciones está asociada a un efecto estocástico de\nlas radiaciones?",
  ...
  {
    "numb": 31,
    "question": "En una curva de sobrevida celular en función de la dosis de radiación ¿qué\nsignificado tiene el parámetro dosis cuasiumbral?",
  ...
  {
    "numb": 32,
    "question": "En cuanto a la utilización de blindajes como método de radioprotección, ¿qué\nrepresenta la capa hemireductora?",
  ...
  {
    "numb": 33,
    "question": "¿Cuál de los siguientes parámetros es necesario para poder realizar\ndiagnóstico de insuficiencia respiratoria? \n",
  ...
  {
    "numb": 35,
    "question": "Indique cuál de los siguientes hallazgos clínicos puede considerarse específico\nde los estados de shock:",
  ...
  {
    "numb": 36,
    "question": "¿Cuál de las siguientes características permite diferenciar al shock séptico del\nshock cardiogénico?",
  ...
  {
    "numb": 37,
    "question": "¿En cuál de los siguientes tipos de shock se puede encontrar una fase\nhiperdinámica y una hipodinámica?",
    "answer": "Distributivo",
    "options": [
      "Distributivo",
      "Obstructivo",
  ...
  {
    "numb": 38,
    "question": "En un paciente con fibrosis pulmonar, ¿qué alteración funcional espera\nencontrar?",
  ...
  {
    "numb": 41,
    "question": "¿Qué parámetro tiene utilidad para diferenciar la injuria renal aguda\nparenquimatosa de la prerenal?",
  ...
  {
    "numb": 42,
    "question": "¿Cuál es el principal rol de los factores de transcripción inducidos por hipoxia\n(HIF)?",
  ...
  {
    "numb": 47,
    "question": "Señale la afirmación correcta sobre los parámetros de absorción de un fármaco\nA administrado en dosis única por vía oral:\n",
  ...
  {
    "numb": 48,
    "question": "Señale la afirmación correcta respecto a la curva dosis-respuesta de fármacos\nagonistas y antagonistas:",
  ...
  {
    "numb": 49,
    "question": "¿Cuál de los siguientes mecanismos de acción se asocia con efectos\nfarmacológicos simpaticomiméticos?",
  ...
  {
    "numb": 50,
    "question": "¿Cuál de las siguientes es una posible reacción adversa mediada por efecto\nantimuscarínico de algunos antihistamínicos o psicofármacos?",
  ...
  {
    "numb": 51,
    "question": "La inhibición selectiva sobre la ciclooxigenasa 2 de algunos antiinflamatorios\nno esteroideos como celecoxib se asocia con mayor riesgo epidemiológico de ciertos eventos adversos, respecto a otros antiinflamatorios no selectivos como ketoprofeno. ¿Cuál de los siguientes constituye un efecto adverso de dicho grupo farmacológico?",
  ...
  {
    "numb": 54,
    "question": "¿Cuál es la razón por la cual claritromicina y azitromicina no son útiles en\ninfecciones urinarias?",
  ...
  {
    "numb": 55,
    "question": "Señale la afirmación correcta sobre riesgos asociados al uso de\nanticonceptivos orales con estrógenos:",
  ...
  {
    "numb": 56,
    "question": "¿Cuál de las siguientes es una reacción adversa tipo A que puede observarse\nluego de una dosis única de prednisona 1 mg/kg por vía oral?",
  ...
  {
    "numb": 57,
    "question": "¿Cuál de las siguientes características de la observación microscópica es útil\nen el diagnóstico de la esteatosis hepática?",
  ...
  {
    "numb": 59,
    "question": "¿Cuál es el patrón morfológico de inflamación aguda que se observa en la\napendicitis aguda?",
  ...
  {
    "numb": 60,
    "question": "¿Cuál de las siguientes señales químicas activa a los macrófagos durante la\ninflamación crónica? ",
    "answer": "IFN-gamma",
    "options": [
      "ERO",
      "IL-10",
